...
/***/ function(module, exports, __webpack_require__) {
	...
	var Mesa = __webpack_require__(159);

	ReactDOM.render(React.createElement(Mesa, {
	  __source: {
	    fileName: '../../../static/app/index.js',
	    lineNumber: 5
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MessageList = __webpack_require__(161);
	...
	var Mesa = React.createClass({
	  ...
	  componentDidMount: function componentDidMount() {
	    fetch('/api/statuses/').then(function (response) {
	  ...
	  handleDelete: function handleDelete(message, e) {
	    e.preventDefault();
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      {
	        __source: {
	          fileName: '../../../static/app/components/Mesa.jsx',
	          lineNumber: 72
	        }
	      },
	      React.createElement(Form, { onSubmit: this.handleSubmit, __source: {
	          fileName: '../../../static/app/components/Mesa.jsx',
	          lineNumber: 73
	        }
	      }),
	  ...
	  render: function render() {
	    return React.createElement(
	      'form',
	      {
	        ...
	        className: 'form',
	        __source: {
	          fileName: '../../../static/app/components/Form.jsx',
	          lineNumber: 13
	        }
	      },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MessageList = function MessageList(props) {
	  return React.createElement(
	    ...
	    {
	      __source: {
	        fileName: '../../../static/app/components/MessageList.jsx',
	        lineNumber: 5
	      }
	    },
	...
	var Message = function Message(props) {
	  return React.createElement(
	    ...
	    { className: "message", __source: {
	        fileName: "../../../static/app/components/Message.jsx",
	        lineNumber: 5
	      }
	    },
	    React.createElement(
	    ...
	    React.createElement(
	      "a",
	      { href: "", onClick: props.onDelete.bind(null, props.message), __source: {
	          fileName: "../../../static/app/components/Message.jsx",
	          lineNumber: 8
	        }
	      },
